...
enum ImGuiWindowFlags_
{
    ...
    ImGuiWindowFlags_NoCollapse             = 1 << 5,   // Disable user collapsing window by double-clicking on it. Also referred to as Window Menu Button (e.g. within a docking node).//使用的是这个
...
enum ImGuiTabBarFlags_
{
    ...
    ImGuiTabBarFlags_NoTooltip                      = 1 << 5,   // Disable tooltips when hovering a tab使用的是这个
